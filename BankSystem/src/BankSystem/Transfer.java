...
public class Transfer 
{
    ...
    JCheckBox toChecking = new JCheckBox("Transfer from savings to checking");
    JCheckBox toSavings = new JCheckBox("Transfer from checking to savings");
    
    /**
     * Creates the window to transfer money
     */
    public Transfer()
    {
    ...
    /**
     * Transfers money into account and updates balances accordingly
    	...
    	else if (isInt(userInput))
    	{
    		...
    		if (toChecking.isSelected() && !toSavings.isSelected())
    		{
    			if (BankSystem.getSavingsBalance() >= amount)
    			{
    				...
    				BankSystem.addSavingsBalance(-amount);
	       	    	success.setText("Transfered $" + amount + " to checking");
    		...
    		else if (toSavings.isSelected() && !toChecking.isSelected())
            {
    			if (BankSystem.getCheckingBalance() >= amount)
    			{
    				BankSystem.addCheckingBalance(-amount);
    				BankSystem.addSavingsBalance(amount);
    				success.setText("Transfered $" + amount + " to savings");
    				success.setForeground(Color.GREEN);
    			}
    			else
    			{
